void controlP5setup() {
  ...
  cp5.addSlider("minDepth", 0, 200, 10, 10, sliderWidth-25, sliderHeight).setGroup(KinectControls).listen(true);
  cp5.addSlider("maxDepth", 800, 1000, 10, 30, sliderWidth-25, sliderHeight).setGroup(KinectControls).listen(true);
