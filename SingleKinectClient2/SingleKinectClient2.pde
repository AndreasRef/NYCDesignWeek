...
//This sketch has ONE(!) Kinect input and sends the button/blob information to the server

//Update April 20th: Cleanup
//Update April 25th: Grid is now 6*7
//Update May 5th: Setup for one Kinect only. Grid size is 4x7
...
void setup() {
  ...
  frameRate(30); //Attempt to avoid jumpyness and communication errors... 
  ...
  //Client
  client = new Client(this, "169.254.139.134", 5205); //The ip address is subject to change, so make sure you have it right every time you start up the program.
